    ...
    <div className="relative min-h-screen flex items-center justify-center bg-custom-gradient">
      ...
      <div className="w-full max-w-[480px] bg-white shadow-md rounded-lg overflow-hidden absolute left-0 top-0 bottom-0 z-10">
        <div className="p-6">
          ...
          <h5
            className={`text-xs font-bold text-midnight-blue text-center mb-5 ${inteBold.className}`}
          >
            We have sent a confirmation code to your email, please enter the
            confirmation code to activate your account.
          </h5>
          <form onSubmit={onSubmit} className="space-y-6 pl-[20px] pr-[20px]">
            <div>
            ...
            >
              <span className="flex-grow text-center ml-5">Submit</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
